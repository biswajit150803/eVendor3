  ...
  return (
    <div className="faq-container">
      ...
      <div className="faq-tab-container">
        ...
        <Accordion>
              <Accordion.Item eventKey="0" className="acc"  data-aos="fade-right">
              ...
              <Accordion.Item eventKey="1" className="acc"  data-aos="fade-right">
              ...
              <Accordion.Item eventKey="2" className="acc"  data-aos="fade-right">
              ...
              <Accordion.Item eventKey="3" className="acc"  data-aos="fade-right">
        ...
        <div className="faq-right">
              <Accordion>
              <Accordion.Item eventKey="4" className="acc"  data-aos="fade-left">
              ...
              <Accordion.Item eventKey="5" className="acc"  data-aos="fade-left">
              ...
              <Accordion.Item eventKey="6" className="acc"  data-aos="fade-left">
              ...
              <Accordion.Item eventKey="7" className="acc"  data-aos="fade-left">
