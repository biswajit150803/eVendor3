...
const CPastorders = (props) => {
  ...
  const handleOrderSubmit = async () => {
    ...
    if (res.events.success.returnValues[1]) {
      ...
      if (phoneRef.current.value.length !== 10) {
        ...
        await axios.post("http://localhost:8009/api/web3/order", data);
        console.log(
          "O: " +
  ...
  const customerDeny = async (e, id, hash) => {
    ...
    if (res.events.success.returnValues[1]) {
      ...
      ////////////////////////////////////////////////////
      console.log(data);
      await axios.post("http://localhost:8009/api/web3/customerdeny", data);
  ...
  const partialPayment = async () => {
    ...
    if (res.events.success.returnValues[1]) {
      ...
      ////////////////////////////////////////////////////
      await axios.post("http://localhost:8009/api/web3/customeraccept", data);
      window.location.reload();
    }
  }
